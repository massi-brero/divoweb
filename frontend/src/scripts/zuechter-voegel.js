...
async function determineColor() {
  ...
  if (!skl1) {
    showToast(
      "Bitte mindestens den ersten Schauklassenschlüssel eingeben.",
      "error",
    );
    skl1Input.focus();
    return;
  ...
  try {
    ...
    showToast(
      `Vogelklasse ${vogelklasse.klassenschluessel} wurde gefunden.`,
      "success",
    );
  } catch (error) {
